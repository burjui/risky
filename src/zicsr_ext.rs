...
use super::encoding::{i_instruction, Imm12OrCsr};
use crate::{
    common::{csr::Csr, funct3::Funct3, opcode::Opcode, reg_or_uimm5::RegOrUimm5, uimm5::Uimm5},
...
#[must_use]
#[inline]
pub const fn csrrw(rd: Register, rs1: Register, csr: Csr) -> u32 {
...
#[must_use]
#[inline]
pub const fn csrrs(rd: Register, rs1: Register, csr: Csr) -> u32 {
...
#[must_use]
#[inline]
pub const fn csrr(rd: Register, csr: Csr) -> u32 {
    csrrs(rd, X0, csr)
}
...
#[must_use]
#[inline]
pub const fn csrs(rs1: Register, csr: Csr) -> u32 {
    csrrs(X0, rs1, csr)
}
...
#[must_use]
#[inline]
pub const fn csrrc(rd: Register, rs1: Register, csr: Csr) -> u32 {
...
#[must_use]
#[inline]
pub const fn csrc(rs1: Register, csr: Csr) -> u32 {
    csrrc(X0, rs1, csr)
}
...
#[must_use]
#[inline]
pub const fn csrrwi(rd: Register, uimm: Uimm5, csr: Csr) -> u32 {
...
#[must_use]
#[inline]
pub const fn csrrsi(rd: Register, uimm: Uimm5, csr: Csr) -> u32 {
...
#[must_use]
#[inline]
pub const fn csrsi(uimm: Uimm5, csr: Csr) -> u32 {
    csrrsi(X0, uimm, csr)
}
...
#[must_use]
#[inline]
pub const fn csrrci(rd: Register, uimm: Uimm5, csr: Csr) -> u32 {
...
#[must_use]
#[inline]
pub const fn csrci(uimm: Uimm5, csr: Csr) -> u32 {
    csrrci(X0, uimm, csr)
}
...
/// ```
const fn csr_instruction(rd: Register, mask: RegOrUimm5, csr: Csr, funct3: Funct3) -> u32 {
    i_instruction(Opcode::SYSTEM, rd, funct3, mask, Imm12OrCsr::Csr(csr))
}
