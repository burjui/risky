...
use super::encoding::{
    b_instruction, fence, funct3, funct7, i_instruction, j_instruction, opcode, r_instruction,
...
/// return address register and [X5](super::registers::X5) as an alternate link register (more details in the
/// [abi](super::abi) module).
///
...
/// "Jump And Link from u8" instruction performs an indirect jump. The target address is obtained by
/// adding the sign-extended 12-bit `imm` to the register `rs1`, then setting the least-significant
/// bit of the result to zero. The address of the instruction following the `jalr` (pc+4) is written
/// to the register `rd`. u8 [X0](super::registers::X0) can be used as the destination if the result
/// is not required.
///
...
pub const fn jalr(rd: u8, rs1: u8, imm: i16) -> u32 {
    i_instruction(opcode::JALR, rd, funct3::JALR, rs1, imm)
}
...
#[must_use]
#[inline]
pub const fn beq(imm: i16, rs1: u8, rs2: u8) -> u32 {
...
#[must_use]
#[inline]
pub const fn bne(imm: i16, rs1: u8, rs2: u8) -> u32 {
...
#[must_use]
#[inline]
pub const fn blt(imm: i16, rs1: u8, rs2: u8) -> u32 {
...
#[must_use]
#[inline]
pub const fn bltu(imm: i16, rs1: u8, rs2: u8) -> u32 {
...
#[must_use]
#[inline]
pub const fn bge(imm: i16, rs1: u8, rs2: u8) -> u32 {
...
#[must_use]
#[inline]
pub const fn bgeu(imm: i16, rs1: u8, rs2: u8) -> u32 {
...
#[must_use]
#[inline]
pub const fn lb(rd: u8, rs1: u8, imm: i16) -> u32 {
    i_instruction(opcode::LOAD, rd, funct3::LB, rs1, imm)
}
...
#[must_use]
#[inline]
pub const fn lbu(rd: u8, rs1: u8, imm: i16) -> u32 {
    i_instruction(opcode::LOAD, rd, funct3::LBU, rs1, imm)
}
...
#[must_use]
#[inline]
pub const fn lh(rd: u8, rs1: u8, imm: i16) -> u32 {
    i_instruction(opcode::LOAD, rd, funct3::LH, rs1, imm)
}
...
#[must_use]
#[inline]
pub const fn lhu(rd: u8, rs1: u8, imm: i16) -> u32 {
    i_instruction(opcode::LOAD, rd, funct3::LHU, rs1, imm)
}
...
#[must_use]
#[inline]
pub const fn lw(rd: u8, rs1: u8, imm: i16) -> u32 {
    i_instruction(opcode::LOAD, rd, funct3::LW, rs1, imm)
}
...
#[must_use]
#[inline]
pub const fn sb(rs1: u8, imm: i16, rs2: u8) -> u32 {
...
#[must_use]
#[inline]
pub const fn sh(rs1: u8, imm: i16, rs2: u8) -> u32 {
...
#[must_use]
#[inline]
pub const fn sw(rs1: u8, imm: i16, rs2: u8) -> u32 {
...
#[must_use]
#[inline]
pub const fn addi(rd: u8, rs1: u8, imm: i16) -> u32 {
    i_instruction(opcode::OP_IMM, rd, funct3::ADDI, rs1, imm)
}
...
#[must_use]
#[inline]
pub const fn mv(rd: u8, rs1: u8) -> u32 {
    addi(rd, rs1, 0)
}
...
#[must_use]
#[inline]
pub const fn slti(rd: u8, rs1: u8, imm: i16) -> u32 {
    i_instruction(opcode::OP_IMM, rd, funct3::SLTI, rs1, imm)
}
...
#[must_use]
#[inline]
pub const fn sltiu(rd: u8, rs1: u8, imm: i16) -> u32 {
    i_instruction(opcode::OP_IMM, rd, funct3::SLTIU, rs1, imm)
}
...
#[must_use]
#[inline]
pub const fn seqz(rd: u8, rs1: u8) -> u32 {
    sltiu(rd, rs1, 1)
}
...
#[must_use]
#[inline]
pub const fn xori(rd: u8, rs1: u8, imm: i16) -> u32 {
    i_instruction(opcode::OP_IMM, rd, funct3::XORI, rs1, imm)
}
...
#[must_use]
#[inline]
pub const fn not(rd: u8, rs1: u8) -> u32 {
    xori(rd, rs1, -1)
}
...
#[must_use]
#[inline]
pub const fn ori(rd: u8, rs1: u8, imm: i16) -> u32 {
    i_instruction(opcode::OP_IMM, rd, funct3::ORI, rs1, imm)
}
...
#[must_use]
#[inline]
pub const fn andi(rd: u8, rs1: u8, imm: i16) -> u32 {
    i_instruction(opcode::OP_IMM, rd, funct3::ANDI, rs1, imm)
}
...
#[must_use]
#[inline]
pub const fn slli(rd: u8, rs1: u8, shamt: u8) -> u32 {
    r_instruction(opcode::OP_IMM, rd, funct3::SLLI, rs1, shamt, funct7::SLL)
}
...
#[must_use]
#[inline]
pub const fn srli(rd: u8, rs1: u8, shamt: u8) -> u32 {
    r_instruction(opcode::OP_IMM, rd, funct3::SRLI, rs1, shamt, funct7::SRL)
}
...
#[must_use]
#[inline]
pub const fn srai(rd: u8, rs1: u8, shamt: u8) -> u32 {
    r_instruction(opcode::OP_IMM, rd, funct3::SRAI, rs1, shamt, funct7::SRA)
}
...
#[must_use]
#[inline]
pub const fn snez(rd: u8, rs2: u8) -> u32 {
    sltu(rd, 0, rs2)
}
...
/// operations in its `successor` set. Refer to [`u8`] documentation for further details.
///
...
#[must_use]
#[inline]
pub const fn fence(predecessor: u8, successor: u8) -> u32 {
    fence_instruction(fence::FENCE_MODE_DEFAULT, predecessor, successor)
}
...
const fn fence_instruction(fm: u8, predecessor: u8, successor: u8) -> u32 {
    let imm = merge_bitfields(&[
        (0..4, predecessor as u32, 0..4),
        (4..8, successor as u32, 0..4),
        (8..12, fm as u32, 0..4),
    ]);
    i_instruction(opcode::MISC_MEM, 0, funct3::FENCE, 0, imm as i16)
}
...
pub const fn ecall() -> u32 {
    i_instruction(opcode::SYSTEM, 0, funct3::ECALL, 0, 0)
}
...
/// <code>
/// [slli] [X0](super::registers::X0), [X0](super::registers::X0), 0x1f   # Entry NOP
/// ebreak              # Break to debugger
/// [srai] [X0](super::registers::X0), [X0](super::registers::X0), 7      # NOP encoding the semihosting call number 7
/// </code>
/// <br/>
///
...
pub const fn ebreak() -> u32 {
    i_instruction(opcode::SYSTEM, 0, funct3::EBREAK, 0, 1)
}
